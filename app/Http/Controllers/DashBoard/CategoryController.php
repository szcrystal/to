...
{
    public function __construct(Category $category, UserImg $userImg, Setting $setting)
    {
    ...
    public function show($id)
    {
        ...
        return view('dashboard.category.form', ['cate'=>$cate, 'imgCount'=>$imgCount, 'id'=>$id, 'edit'=>1]);
    }
